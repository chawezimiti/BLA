...
Install the current version on Github. You will need to install the package `devtools` before installing BLA. Also ensure that the dependent packages `aplpack`, `MASS` and `mvtnorm` are installed.
