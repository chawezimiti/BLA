...
summastat(x) # Gives indices for skewness. Normal distribution range of -1 to 1. If not normally distributed,a transformation is required 
...
summastat(y)# Gives indices for skewness. Normal distribution range of -1 to 1. If not normally distributed,a transformation is required 
